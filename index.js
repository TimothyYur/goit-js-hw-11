import{r as e}from"./assets/rolldown-runtime-Cq0jCQ29.js";import{n as t,t as n}from"./assets/vendor-DMlyE9ZX.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var r=`55201834-b2019b61559684ce41de74b7e`,i=`https://pixabay.com/api/`;function a(e){let n={key:r,q:e,image_type:`photo`,orientation:`horizontal`,safesearch:!0};return t.get(i,{params:n}).then(e=>e.data.hits).catch(e=>{throw Error(`Failed to fetch images`)})}var o=e(n(),1),s=document.querySelector(`.gallery`),c;function l(e){if(e.length===0){u(`Sorry, there are no images matching your search query. Please try again!`);return}s.innerHTML=e.map(e=>`
